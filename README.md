...
[![CI](https://github.com/FlorenciaMorelli/wc_match_predictor_frontend/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/FlorenciaMorelli/wc_match_predictor_frontend/actions/workflows/ci.yml)
...
├── lib/          # Cliente API, i18n, helpers (kits, match-report, model-eval, text…) + tests (*.test.ts)
...
| `npm test`             | Tests unitarios (Vitest, lógica pura de `lib/`) |
