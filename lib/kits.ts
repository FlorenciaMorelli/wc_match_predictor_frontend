...
const DEFAULT_TEAM_KITS: TeamKits = {
  home: DEFAULT_KIT,
  away: DEFAULT_KIT,
  third: DEFAULT_KIT,
};
...
function pickPair(
  ...
  let pick = candidates.find(
    (k) => !clashes(lp, k.primary) && isLightColor(k.primary) !== lightL
  );
...
function shirtToKit(iso: string, desc: string): Kit {
  ...
  if (
    iso === "ar" &&
    !has("navy") &&
    (has("light") || has("sky") || has("white"))
  )
    return KITS.ar.home;
  if (iso === "hr" && !has("navy") && !has("blue") && has("red"))
    return KITS.hr.home;
  if (iso === "us" && has("white") && has("red"))
    return { primary: "#FFFFFF", secondary: "#BF0A30", pattern: "stripes" };

  const primary =
    colorToHex(tokens[0] ?? "") ??
    KITS[iso]?.home.primary ??
    DEFAULT_KIT.primary;
...
const MATCH_COLOURS: Record<string, Partial<Record<string, SideColours>>> = {
  "mx|za": {
    mx: { shirt: "green", gk: "purple" },
    za: { shirt: "yellow", gk: "light blue" },
  },
  "cz|kr": {
    kr: { shirt: "red", gk: "yellow" },
    cz: { shirt: "white", gk: "turquoise" },
  },
  "ba|ca": {
    ca: { shirt: "red", gk: "blue" },
    ba: { shirt: "white", gk: "yellow" },
  },
  "py|us": {
    us: { shirt: "white / red", gk: "yellow" },
    py: { shirt: "navy blue", gk: "orange" },
  },
  "gb-sct|ht": {
    ht: { shirt: "white", gk: "yellow" },
    "gb-sct": { shirt: "red", gk: "blue" },
  },
  "au|tr": {
    au: { shirt: "gold", gk: "black" },
    tr: { shirt: "port red", gk: "blue" },
  },
  "br|ma": {
    br: { shirt: "yellow", gk: "light grey" },
    ma: { shirt: "red", gk: "light blue" },
  },
  "ch|qa": {
    qa: { shirt: "maroon", gk: "yellow" },
    ch: { shirt: "light grey", gk: "light blue" },
  },
  "ci|ec": {
    ci: { shirt: "orange", gk: "turquoise" },
    ec: { shirt: "navy blue", gk: "olive green" },
  },
  "cw|de": {
    de: { shirt: "white", gk: "dark green" },
    cw: { shirt: "blue", gk: "orange" },
  },
  "jp|nl": { nl: { shirt: "orange", gk: "green" }, jp: { shirt: "navy blue" } },
  "se|tn": {
    se: { shirt: "yellow", gk: "green" },
    tn: { shirt: "red", gk: "turquoise" },
  },
  "sa|uy": {
    sa: { shirt: "dark green", gk: "yellow" },
    uy: { shirt: "light blue", gk: "orange" },
  },
  "cv|es": { es: { shirt: "red" }, cv: { shirt: "white", gk: "yellow" } },
  "ir|nz": {
    ir: { shirt: "white", gk: "light blue" },
    nz: { shirt: "black", gk: "magenta" },
  },
  "be|eg": {
    be: { shirt: "red", gk: "green" },
    eg: { shirt: "white", gk: "light green" },
  },
  "fr|sn": {
    fr: { shirt: "navy blue", gk: "yellow" },
    sn: { shirt: "white", gk: "orange" },
  },
  "iq|no": {
    iq: { shirt: "white", gk: "yellow" },
    no: { shirt: "red", gk: "light blue" },
  },
  "ar|dz": {
    ar: { shirt: "white / light" },
    dz: { shirt: "dark green", gk: "yellow" },
  },
  "at|jo": {
    at: { shirt: "red", gk: "light blue" },
    jo: { shirt: "white", gk: "yellow" },
  },
  "gh|pa": {
    gh: { shirt: "yellow", gk: "turquoise" },
    pa: { shirt: "red", gk: "grey" },
  },
  "gb-eng|hr": {
    "gb-eng": { shirt: "white / red" },
    hr: { shirt: "blue / navy" },
  },
  "cd|pt": {
    pt: { shirt: "port red", gk: "gold" },
    cd: { shirt: "blue", gk: "light grey" },
  },
  "co|uz": {
    uz: { shirt: "white", gk: "orange" },
    co: { shirt: "navy blue", gk: "magenta" },
  },
  "cz|za": { cz: { shirt: "red" }, za: { shirt: "yellow", gk: "light blue" } },
  "ba|ch": {
    ch: { shirt: "red", gk: "light blue" },
    ba: { shirt: "white", gk: "yellow" },
  },
  "ca|qa": {
    ca: { shirt: "black", gk: "yellow" },
    qa: { shirt: "white", gk: "dark green" },
  },
  "kr|mx": {
    mx: { shirt: "black", gk: "olive green" },
    kr: { shirt: "magenta", gk: "yellow" },
  },
  "br|ht": {
    br: { shirt: "navy blue", gk: "magenta" },
    ht: { shirt: "white", gk: "yellow" },
  },
  "gb-sct|ma": {
    "gb-sct": { shirt: "navy blue", gk: "yellow" },
    ma: { shirt: "white", gk: "neon green" },
  },
  "py|tr": { tr: { shirt: "white" }, py: { shirt: "navy blue", gk: "orange" } },
  "au|us": {
    us: { shirt: "white / red", gk: "blue" },
    au: { shirt: "gold", gk: "purple" },
  },
  "ci|de": {
    de: { shirt: "white", gk: "blue" },
    ci: { shirt: "orange", gk: "yellow" },
  },
  "cw|ec": {
    ec: { shirt: "yellow", gk: "blue" },
    cw: { shirt: "blue", gk: "light grey" },
  },
  "nl|se": {
    nl: { shirt: "orange", gk: "green" },
    se: { shirt: "blue", gk: "light grey" },
  },
  "jp|tn": {
    tn: { shirt: "white", gk: "orange" },
    jp: { shirt: "navy blue", gk: "yellow" },
  },
  "cv|uy": {
    uy: { shirt: "light blue", gk: "green" },
    cv: { shirt: "red", gk: "yellow" },
  },
  ...
  "eg|nz": {
    nz: { shirt: "white", gk: "neon green" },
    eg: { shirt: "red", gk: "green" },
  },
  "no|sn": { no: { shirt: "black", gk: "light blue" }, sn: { shirt: "white" } },
  "fr|iq": {
    fr: { shirt: "navy blue", gk: "yellow" },
    iq: { shirt: "white", gk: "orange" },
  },
  "ar|at": {
    ar: { shirt: "white / light" },
    at: { shirt: "red", gk: "yellow" },
  },
  "dz|jo": {
    jo: { shirt: "red", gk: "yellow" },
    dz: { shirt: "white", gk: "light blue" },
  },
  "gb-eng|gh": {
    "gb-eng": { shirt: "white / red" },
    gh: { shirt: "yellow", gk: "magenta" },
  },
  "hr|pa": {
    pa: { shirt: "navy blue", gk: "neon green" },
    hr: { shirt: "white / red", gk: "yellow" },
  },
  "pt|uz": {
    pt: { shirt: "port red", gk: "neon green" },
    uz: { shirt: "white", gk: "neon green" },
  },
  "cd|co": {
    co: { shirt: "yellow / red", gk: "green" },
    cd: { shirt: "blue", gk: "light grey" },
  },
  "br|gb-sct": {
    "gb-sct": { shirt: "navy blue", gk: "grey" },
    br: { shirt: "yellow", gk: "red" },
  },
  "ht|ma": {
    ma: { shirt: "red", gk: "white" },
    ht: { shirt: "blue", gk: "yellow" },
  },
  "ca|ch": {
    ch: { shirt: "red", gk: "yellow" },
    ca: { shirt: "white", gk: "blue" },
  },
  "ba|qa": {
    ba: { shirt: "blue", gk: "orange" },
    qa: { shirt: "white", gk: "yellow" },
  },
  "cz|mx": { cz: { shirt: "red" }, mx: { shirt: "white", gk: "green" } },
  "kr|za": {
    za: { shirt: "yellow", gk: "light blue" },
    kr: { shirt: "red", gk: "green" },
  },
  "ci|cw": {
    cw: { shirt: "blue", gk: "light grey" },
    ci: { shirt: "orange", gk: "yellow" },
  ...
  "de|ec": {
    ec: { shirt: "yellow" },
    de: { shirt: "navy blue", gk: "orange" },
  },
  "jp|se": { jp: { shirt: "navy blue" }, se: { shirt: "yellow", gk: "green" } },
  "nl|tn": {
    tn: { shirt: "white", gk: "turquoise" },
    nl: { shirt: "orange", gk: "green" },
  },
  "tr|us": { tr: { shirt: "white" }, us: { shirt: "navy blue", gk: "yellow" } },
  "au|py": {
    py: { shirt: "red", gk: "light blue" },
    au: { shirt: "gold", gk: "black" },
  },
  "fr|no": {
    no: { shirt: "red", gk: "light blue" },
    fr: { shirt: "light green", gk: "yellow" },
  },
  "iq|sn": { sn: { shirt: "white" }, iq: { shirt: "dark green", gk: "black" } },
  "eg|ir": {
    eg: { shirt: "red", gk: "yellow" },
    ir: { shirt: "white", gk: "light blue" },
  },
  "be|nz": {
    nz: { shirt: "white", gk: "neon green" },
    be: { shirt: "red", gk: "yellow" },
  },
  "cv|sa": {
    cv: { shirt: "navy blue", gk: "yellow" },
    sa: { shirt: "white", gk: "light blue" },
  },
  "es|uy": {
    uy: { shirt: "navy blue", gk: "orange" },
    es: { shirt: "white", gk: "yellow" },
  },
  "gb-eng|pa": {
    pa: { shirt: "white", gk: "turquoise" },
    "gb-eng": { shirt: "red", gk: "olive green" },
  },
  "gh|hr": {
    hr: { shirt: "white / red", gk: "green" },
    gh: { shirt: "yellow", gk: "turquoise" },
  },
  "at|dz": {
    dz: { shirt: "white", gk: "light blue" },
  ...
  "ar|jo": {
    jo: { shirt: "white", gk: "yellow" },
    ar: { shirt: "navy blue", gk: "dark green" },
  },
  "co|pt": {
    co: { shirt: "yellow / red", gk: "light grey" },
    pt: { shirt: "port red", gk: "neon green" },
  },
  "cd|uz": {
    cd: { shirt: "red", gk: "green" },
    uz: { shirt: "white", gk: "grey" },
  },
};
...
export function designationFor(
  ...
  return {
    a: {
      kit: shirtToKit(isoA, a.shirt),
      gk: colorToHex(a.gk ?? "") ?? undefined,
    },
    b: {
      kit: shirtToKit(isoB, b.shirt),
      gk: colorToHex(b.gk ?? "") ?? undefined,
    },
  };
}
